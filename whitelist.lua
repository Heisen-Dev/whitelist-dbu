local users = {'YaEsta_EnUs0', 'chicles20191', '32Wex23', '23Wex32', 'derbexsaak', 'goyito132', 'Tech_Sorcerer',
	...
	'PollySenko', 'SumetRG', 'Not_Bxnds', 'Benceke2', 'Radiantprime23', 'Gonsi9', 'soynuevoxd6776','BORUTOBR1202', 'TheFinal126', 'pultaro',
	...
	'Juancarlosvillo', 'DEVIL9550', 'XxjiangamingYT', 'mastery_123', 'Scripting_Business', 'Aus_728', 'ADRIAN1023A', 'prozin_sonhador', 'floflobosurito', 'Pwvnac'

	--Remover el darkzbiade, BemYaer, L4superLEGIT, jwn2odi2, Scripting_Business el domingo (script por invitacion)
}
